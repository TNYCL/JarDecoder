...
public class ConstantPool {
        ...
        for (int x = 0; x < count; ++x) {
            ...
            switch (type) {
                ...
                case CPT_PackageInfo:
                    ...
                    break;
                default:
                    throw new ConfusedDecompilerException("Invalid constant pool entry : " + type);
            }
            logger.info("" + (x + 1) + " : " + cpe);
            tgt.add(cpe);
            switch (type) {
    ...
    public ConstantPoolEntry getEntry(int index) {
        if (index == 0) throw new ConfusedDecompilerException("Attempt to fetch element 0 from constant pool");
