...
import com.decompiler.bytecode.analysis.variables.VariableNamerFactory;
...
import com.decompiler.state.LocalClassAwareTypeUsageInformation;
...
public class Method implements KnowsRawSize, TypeUsageCollectable {
    ...
    public Op04StructuredStatement getAnalysis() {
        if (codeAttribute == null) throw new ConfusedDecompilerException("No code in this method to analyze");
