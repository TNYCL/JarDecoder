...
import com.decompiler.bytecode.analysis.loc.BytecodeLocFactory;
import com.decompiler.bytecode.analysis.loc.BytecodeLocFactoryImpl;
import com.decompiler.bytecode.analysis.loc.BytecodeLocFactoryStub;
...
import com.decompiler.bytecode.analysis.opgraph.Op03Blocks;
import com.decompiler.bytecode.analysis.opgraph.Op03SimpleStatement;
import com.decompiler.bytecode.analysis.opgraph.Op04StructuredStatement;
import com.decompiler.bytecode.analysis.opgraph.op02obf.Op02Obf;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.GetClassTestInnerConstructor;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.GetClassTestLambda;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.Op02GetClassRewriter;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.Op02RedundantStoreRewriter;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.TypeHintRecovery;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.TypeHintRecoveryImpl;
import com.decompiler.bytecode.analysis.opgraph.op2rewriters.TypeHintRecoveryNone;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.AnonymousArray;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.BadBoolAssignmentRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.BadNarrowingArgRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.Cleaner;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.ConditionalRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.ExceptionRewriters;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.FinallyRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.GenericInferer;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.InlineDeAssigner;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.IterLoopRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.KotlinSwitchHandler;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.LValueProp;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.LValuePropSimple;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.LoopIdentifier;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.LoopLivenessClash;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.Misc;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.NullTypedLValueRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.Op03Rewriters;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.RemoveDeterministicJumps;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.StaticInitReturnRewriter;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.SwitchReplacer;
import com.decompiler.bytecode.analysis.opgraph.op3rewriters.SynchronizedBlocks;
import com.decompiler.bytecode.analysis.opgraph.op4rewriters.SwitchEnumRewriter;
import com.decompiler.bytecode.analysis.opgraph.op4rewriters.SwitchStringRewriter;
import com.decompiler.bytecode.analysis.opgraph.op4rewriters.checker.IllegalReturnChecker;
import com.decompiler.bytecode.analysis.opgraph.op4rewriters.checker.LooseCatchChecker;
import com.decompiler.bytecode.analysis.opgraph.op4rewriters.checker.VoidVariableChecker;
import com.decompiler.bytecode.analysis.parse.rewriters.ExplicitTypeCallRewriter;
import com.decompiler.bytecode.analysis.parse.rewriters.StringBuilderRewriter;
import com.decompiler.bytecode.analysis.parse.rewriters.XorRewriter;
...
import com.decompiler.entities.exceptions.ExceptionTableEntry;
...
import com.decompiler.util.UnverifiableJumpException;
...
public class CodeAnalyser {
    ...
    public Op04StructuredStatement getAnalysis(DCCommonState dcCommonState) {
        if (analysed == POISON) {
             ...
             * intermediate.
             */
            throw new ConfusedDecompilerException("Recursive analysis");
        }
        if (analysed != null) {
            return analysed;
        }
        ...
        for (int x = 0, len = op1list.size(); x < len; ++x) {
            ...
            try {
                ...
                try {
                    ...
                    throw new ConfusedDecompilerException("Can't recover from unverifiable jumps at " + offsetOfThisInstruction);
                }
                len = op1list.size();
            }
        ...
        do {
            ...
            if (targets != null) {
                if (targets.length == 0) {
                    ...
                    throw new ConfusedDecompilerException("Can't currently recover from branching unverifiable instructions.");
                }
            }
