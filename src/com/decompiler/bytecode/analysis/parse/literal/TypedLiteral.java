package com.decompiler.bytecode.analysis.parse.literal;
...
import com.decompiler.bytecode.analysis.types.discovery.InferredJavaType.Source;
...
import com.decompiler.entities.constantpool.ConstantPoolEntryDouble;
import com.decompiler.entities.constantpool.ConstantPoolEntryFloat;
import com.decompiler.entities.constantpool.ConstantPoolEntryInteger;
import com.decompiler.entities.constantpool.ConstantPoolEntryLong;
import com.decompiler.entities.constantpool.ConstantPoolEntryMethodHandle;
import com.decompiler.entities.constantpool.ConstantPoolEntryMethodType;
import com.decompiler.entities.constantpool.ConstantPoolEntryString;
...
public class TypedLiteral implements TypeUsageCollectable, Dumpable {
    ...
    private static String charName(Object o) {
        if (!(o instanceof Integer)) throw new ConfusedDecompilerException("Expecting char-as-int");
        int i = (Integer) o;
        char c = (char) i;
        switch (c) {
            case '\"':
    ...
    private static String boolName(Object o) {
        if (!(o instanceof Integer)) throw new ConfusedDecompilerException("Expecting boolean-as-int");
        int i = (Integer) o;
        switch (i) {
            case 0:
                return "false";
    ...
    public static TypedLiteral getConstantPoolEntry(ConstantPool cp, ConstantPoolEntry cpe) {
        ...
        throw new ConfusedDecompilerException("Can't turn ConstantPoolEntry into Literal - got " + cpe);
    }
