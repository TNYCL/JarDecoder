...
public class WildcardMatch {
    ...
    private static abstract class AbstractBaseExpressionWildcard extends DebugDumpable implements Expression {
        ...
        public BytecodeLoc getCombinedLoc() {
            throw new ConfusedDecompilerException("Should not be getting loc of wildcard");
        }
    ...
    public class ArithmeticMutationWildcard extends AbstractBaseExpressionWildcard implements Wildcard<ArithmeticMutationOperation> {
        ...
        ArithmeticMutationWildcard(com.decompiler.util.Optional<LValue> lhs, com.decompiler.util.Optional<Expression> rhs, com.decompiler.util.Optional<ArithOp> op) {
            this.lhs = new OptionalMatch<LValue>(lhs);
            this.rhs = new OptionalMatch<Expression>(rhs);
            this.op = new OptionalMatch<ArithOp>(op);
        }

        public ArithmeticMutationWildcard(Optional<LValue> lhs2, Optional<Expression> rhs2, Optional<ArithOp> op2) {
			this.lhs = null;
			this.rhs = null;
			this.op = null;
		}
