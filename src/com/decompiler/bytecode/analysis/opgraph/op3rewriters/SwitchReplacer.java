...
import com.decompiler.bytecode.analysis.parse.statement.RawSwitchStatement;
import com.decompiler.bytecode.analysis.parse.statement.ReturnStatement;
...
import com.decompiler.util.CannotPerformDecode;
    ...
    private static Op03SimpleStatement examineSwitchContiguity(Op03SimpleStatement switchStatement, List<Op03SimpleStatement> statements,
        ...
        if (idxFirstCase != statements.indexOf(switchStatement) + 1) {
            ...
            if (switchStatement == null) {
                throw new ConfusedDecompilerException("First case is not immediately after switch.");
            }
        }
            ...
            if (indexLastCase != indexLastInLastBlock + 1) {
                ...
                if (!handled) {
                    ...
                    if (allowMalformedSwitch) {
                        ...
                        throw new ConfusedDecompilerException("Extractable last case doesn't follow previous, and can't clone.");
                    }
                }
            }
