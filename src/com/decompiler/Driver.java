...
import com.decompiler.mapping.MappingFactory;
...
import com.decompiler.util.output.ExceptionDumper;
import com.decompiler.util.output.IllegalIdentifierDump;
import com.decompiler.util.output.NopSummaryDumper;
import com.decompiler.util.output.ProgressDumper;
import com.decompiler.util.output.SummaryDumper;
...
class Driver {
    ...
    static void doJar(DCCommonState dcCommonState, String path, AnalysisType analysisType, DumperFactory dumperFactory) {
        ...
        try {
            ...
            summaryDumper.notify(MiscConstants.ENCODER_HEADER + " " + "1.0");
